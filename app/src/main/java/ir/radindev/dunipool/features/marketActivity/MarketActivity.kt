...
import ir.radindev.dunipool.apiManager.ApiManager
import ir.radindev.dunipool.apiManager.model.CoinAboutData
import ir.radindev.dunipool.apiManager.model.CoinAboutItem
import ir.radindev.dunipool.apiManager.model.CoinsData
import ir.radindev.dunipool.databinding.ActivityMarketBinding
import ir.radindev.dunipool.features.coinActivity.CoinActivity
...
class MarketActivity : AppCompatActivity(), MarketAdapter.RecyclerCallback {
    ...
    private fun firstRunShowDialogWelcome() {
        ...
        if (isFirstRun) {
            ...
            dialog.setMessage("این پروژه توسط رادین مقصودی ساخته شده")
            dialog.show()
